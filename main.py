...
# Define timestamps here so they can be reused
...
def request_social_media_analysis():
    try:
        ...
        if social_media_analysis_response is None:
            raise HTTPException(status_code=500, detail="No data received from request_keyword()")
        return {"genai_response": social_media_analysis_response}
